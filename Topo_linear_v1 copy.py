...
if __name__ == '__main__':
    ...
    def regress(X,y,C = 0.1):
        reg = LogisticRegression(penalty = None,multi_class='ovr', fit_intercept=False, penalty='none', C=C,
    ...
    start = timer()
    W_est, _, _, _ = model.fit(X=X, topo=topo_init, no_large_search=0, size_small=2, size_large=2)
    end = timer()
