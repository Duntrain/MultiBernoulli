...
from Topo_utils import create_Z,create_new_topo,threshold_W,find_topo,find_idx_set_updated
import utils
        ...
        for i in range(0,int(self.num_iter)+1):
            ...
            if self.opti == 'Adam' and (i+1)%200 ==0:
                ...
                if abs((loss - loss_progress[-1])/max(loss_progress[-1],loss,1))<self.tol:
                    ...
                    loss_progress.append(loss)
            if self.opti == 'LBFGS' and (i+1)%5 ==0:
    ...
    def fit(self,
        ...
        while bool(idx_set):
            ...
            for i in range(idx_len):
                ...
                ###############################
                # criterion_clone = utils.best_shd(W = model_clone.layer0_to_adj() ,W_true= B_true)
                ...
                if loss_clone<self.loss:
                    ...
                    # criterion = utils.best_shd(W = model_clone.layer0_to_adj() ,W_true= B_true)
